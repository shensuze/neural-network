...
int main()
{
	...
	while (1) {
		...
		MY_ARGS args1 = { 0,15,0 };
		MY_ARGS args2 = { 16,31,0 };
		MY_ARGS args3 = {32,47,0};
		MY_ARGS args4 = {48,63,0};
		...
		float c = args1.result + args2.result + args3.result + args4.result;
		//c条件判断
		...
		csum_old = args1.result + args2.result + args3.result + args4.result;
